...
const STANDARD_MATERIALS = [
  { name: "Bottle",      uom: "PCS" },
  { name: "Cap",         uom: "PCS" },
  { name: "Front Label", uom: "PCS" },
  { name: "Back Label",  uom: "PCS" },
  { name: "Tikki",       uom: "PCS" },
  { name: "Shrink",      uom: "PCS" },
  { name: "Carton",      uom: "PCS" },
];
...
### Standard Machines for Runtime Tracking

```javascript
const STANDARD_MACHINES = [
  { type: "FILLER",           name: "Filler" },
  { type: "CAPPER",           name: "Capper" },
  { type: "CONVEYOR",         name: "Conveyor" },
  { type: "LABELER",          name: "Labeler" },
  { type: "CODING",           name: "Coding" },
  { type: "SHRINK_PACK",      name: "Shrink Pack" },
  { type: "STICKER_LABELER",  name: "Sticker Labeler (Glass)" },
  { type: "TAPPING_MACHINE",  name: "Tapping Machine" },
];
```
