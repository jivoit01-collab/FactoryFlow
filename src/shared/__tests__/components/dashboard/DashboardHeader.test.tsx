...
describe('DashboardHeader', () => {
  ...
  it('renders description when provided', () => {
    render(<DashboardHeader title="Title" description="A helpful description" />);
  ...
  it('description has muted foreground styling', () => {
    render(<DashboardHeader title="Title" description="Description text" />);
  ...
  it('calls primary action onClick when button is clicked', () => {
    const handleClick = vi.fn();
    render(
      <DashboardHeader title="Title" primaryAction={{ label: 'Add Item', onClick: handleClick }} />,
    );
  ...
  it('renders children alongside primary action', () => {
    const handleClick = vi.fn();
    render(
      <DashboardHeader title="Title" primaryAction={{ label: 'Primary', onClick: handleClick }}>
  ...
  it('applies custom className to the container', () => {
    const { container } = render(<DashboardHeader title="Title" className="custom-class" />);
