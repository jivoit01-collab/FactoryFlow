...
describe('shared/components/ui/card.tsx — file content verification', () => {
  ...
  describe('Card component', () => {
    it('is created with React.forwardRef targeting HTMLDivElement', () => {
      expect(source).toMatch(/const\s+Card\s*=\s*React\.forwardRef<HTMLDivElement/);
    });
  ...
  describe('CardHeader component', () => {
    it('is created with React.forwardRef targeting HTMLDivElement', () => {
      expect(source).toMatch(/const\s+CardHeader\s*=\s*React\.forwardRef<HTMLDivElement/);
    });
  ...
  describe('CardContent component', () => {
    it('is created with React.forwardRef targeting HTMLDivElement', () => {
      expect(source).toMatch(/const\s+CardContent\s*=\s*React\.forwardRef<HTMLDivElement/);
    });
  ...
  describe('CardFooter component', () => {
    it('is created with React.forwardRef targeting HTMLDivElement', () => {
      expect(source).toMatch(/const\s+CardFooter\s*=\s*React\.forwardRef<HTMLDivElement/);
    });
