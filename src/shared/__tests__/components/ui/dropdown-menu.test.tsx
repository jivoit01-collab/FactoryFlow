...
describe('DropdownMenu — File Content Verification', () => {
  ...
  describe('primitive assignments', () => {
    ...
    it('assigns DropdownMenuRadioGroup to DropdownMenuPrimitive.RadioGroup', () => {
      expect(source).toMatch(/const\s+DropdownMenuRadioGroup\s*=\s*DropdownMenuPrimitive\.RadioGroup/)
    })
  })
  ...
  describe('DropdownMenuSubTrigger', () => {
    ...
    it('sets displayName to DropdownMenuPrimitive.SubTrigger.displayName', () => {
      expect(source).toContain('DropdownMenuSubTrigger.displayName = DropdownMenuPrimitive.SubTrigger.displayName')
    })
  })
  ...
  describe('DropdownMenuSubContent', () => {
    ...
    it('sets displayName to DropdownMenuPrimitive.SubContent.displayName', () => {
      expect(source).toContain('DropdownMenuSubContent.displayName = DropdownMenuPrimitive.SubContent.displayName')
    })
  })
  ...
  describe('DropdownMenuContent', () => {
    ...
    it('sets displayName to DropdownMenuPrimitive.Content.displayName', () => {
      expect(source).toContain('DropdownMenuContent.displayName = DropdownMenuPrimitive.Content.displayName')
    })
  })
  ...
  describe('DropdownMenuItem', () => {
    ...
    it('sets displayName to DropdownMenuPrimitive.Item.displayName', () => {
      expect(source).toContain('DropdownMenuItem.displayName = DropdownMenuPrimitive.Item.displayName')
    })
  })
  ...
  describe('DropdownMenuCheckboxItem', () => {
    ...
    it('sets displayName to DropdownMenuPrimitive.CheckboxItem.displayName', () => {
      expect(source).toContain('DropdownMenuCheckboxItem.displayName = DropdownMenuPrimitive.CheckboxItem.displayName')
    })
  })
  ...
  describe('DropdownMenuRadioItem', () => {
    ...
    it('sets displayName to DropdownMenuPrimitive.RadioItem.displayName', () => {
      expect(source).toContain('DropdownMenuRadioItem.displayName = DropdownMenuPrimitive.RadioItem.displayName')
    })
  })
  ...
  describe('DropdownMenuLabel', () => {
    ...
    it('sets displayName to DropdownMenuPrimitive.Label.displayName', () => {
      expect(source).toContain('DropdownMenuLabel.displayName = DropdownMenuPrimitive.Label.displayName')
    })
  })
  ...
  describe('DropdownMenuSeparator', () => {
    ...
    it('sets displayName to DropdownMenuPrimitive.Separator.displayName', () => {
      expect(source).toContain('DropdownMenuSeparator.displayName = DropdownMenuPrimitive.Separator.displayName')
    })
  })
