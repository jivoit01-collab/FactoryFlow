...
describe('useEditFormState', () => {
  ...
  describe('Create Mode (isEditMode: false)', () => {
    it('defaults to non-read-only in create mode', () => {
      const { result } = renderHook(() => useEditFormState({ isEditMode: false }));
  ...
  describe('Edit Mode (isEditMode: true)', () => {
    it('starts as read-only in edit mode', () => {
      const { result } = renderHook(() => useEditFormState({ isEditMode: true }));
  ...
  describe('Callback stability', () => {
    it('enableFillDataMode is stable across re-renders', () => {
      const { result, rerender } = renderHook(() => useEditFormState({ isEditMode: true }));
  ...
  describe('Edge Cases', () => {
    ...
    it('handles empty string entryStatus', () => {
      const { result } = renderHook(() => useEditFormState({ isEditMode: true, entryStatus: '' }));
