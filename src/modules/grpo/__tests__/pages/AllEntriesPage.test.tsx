...
function readSource(): string {
  return readFileSync(resolve(process.cwd(), 'src/modules/grpo/pages/AllEntriesPage.tsx'), 'utf-8');
}
...
describe('AllEntriesPage file content', () => {
  ...
  it('lets a ready, unposted bill jump to the posting preview', () => {
    ...
    expect(content).toContain('/grpo/material/preview/${entry.vehicle_entry_id}');
  });
