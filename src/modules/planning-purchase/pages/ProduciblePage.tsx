...
import type { ProducibleSku, StockBasis } from '../types';
  ...
  return (
    <div className="space-y-4 p-4 sm:p-6">
      ...
      {tab === 'skus' ? (
        ...
        <ComponentDemandTable
          rows={componentRows}
          caption="This is the additive answer: what the whole day's planned mix consumes, added across every product that draws on each material. A shortage here blocks every product listed against it."
        />
      )}
