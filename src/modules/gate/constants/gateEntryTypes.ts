...
export const GATE_ENTRY_TYPES: GateEntryTypeConfig[] = [
  ...
  },
  {
    ...
    icon: LogIn,
    colorClassName: 'text-sky-700 dark:text-sky-400',
  ...
  },
  {
    ...
    icon: RotateCcw,
    colorClassName: 'text-emerald-700 dark:text-emerald-400',
  ...
  },
  {
    ...
    createPermissions: [GATE_PERMISSIONS.REPAIR_MOVEMENT.CREATE],
    icon: Wrench,
    colorClassName: 'text-slate-600 dark:text-muted-foreground',
  ...
  },
  {
    ...
    icon: Undo2,
    colorClassName: 'text-indigo-700 dark:text-indigo-400',
  ...
  },
  {
    ...
    icon: Undo2,
    colorClassName: 'text-rose-700 dark:text-rose-400',
