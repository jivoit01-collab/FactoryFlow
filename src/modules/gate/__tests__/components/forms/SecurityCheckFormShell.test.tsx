...
// ═══════════════════════════════════════════════════════════════
// SecurityCheckFormShell — File Content Verification
// ═══════════════════════════════════════════════════════════════
...
describe('SecurityCheckFormShell', () => {
  const content = readFileSync(
    resolve(process.cwd(), 'src/modules/gate/components/forms/SecurityCheckFormShell.tsx'),
    'utf-8',
  );
  ...
  it('defines SecurityCheckFormShellProps interface', () => {
    expect(content).toContain('SecurityCheckFormShellProps');
  });

  it('renders text "Security Checks"', () => {
    expect(content).toContain('Security Checks');
  });
