...
describe('Gate Module Config', () => {
  ...
  it('lazy-loads RawMaterialsDashboard', () => {
    expect(content).toContain("lazy(() => import('./pages/rawmaterialpages/RawMaterialsDashboard'))")
  })
  ...
  it('lazy-loads MaintenanceDashboard', () => {
    expect(content).toContain("lazy(() => import('./pages/maintenancepages/MaintenanceDashboard'))")
  })

  it('lazy-loads ConstructionDashboard', () => {
    expect(content).toContain("lazy(() => import('./pages/constructionpages/ConstructionDashboard'))")
  })

  it('lazy-loads PersonGateInDashboard', () => {
    expect(content).toContain("lazy(() => import('./pages/persongateinpages/PersonGateInDashboard'))")
  })
