  ...
  const entries = useMemo<RejectedQCReturnEntry[]>(() => {
    ...
    return backendEntries.map((entry) => ({
      ...
      vehicle: {
        ...
        firstWeighmentTime: entry.first_weighment_time || '',
        secondWeighmentTime: entry.second_weighment_time || '',
        gatepassFileNames: entry.gatepass_documents || [],
      ...
      values: {
        ...
        netWeight: entry.net_weight || '',
        weighbridgeSlipNo: entry.weighbridge_slip_no || '',
        gatepassFileNames: JSON.stringify(entry.gatepass_documents || []),
        remarks: entry.remarks || '',
      },
