...
describe('qcParameterApi', () => {
  ...
  it('create calls apiClient.post with materialTypeId and data', async () => {
    const data = { parameter_code: 'PH', parameter_name: 'pH', standard_value: '7', parameter_type: 'NUMERIC' as const, uom: 'pH', sequence: 1, is_mandatory: true }
  ...
  it('update calls apiClient.put with id and data', async () => {
    const data = { parameter_code: 'PH', parameter_name: 'pH Updated', standard_value: '7', parameter_type: 'NUMERIC' as const, uom: 'pH', sequence: 1, is_mandatory: true }
