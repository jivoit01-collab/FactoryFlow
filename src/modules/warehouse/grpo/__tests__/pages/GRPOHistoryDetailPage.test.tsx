...
function readSource(): string {
  ...
  return readFileSync(
    resolve(process.cwd(), 'src/modules/warehouse/grpo/pages/GRPOHistoryDetailPage.tsx'),
    'utf-8',
  );
}
...
describe('GRPOHistoryDetailPage — Header', () => {
  ...
  it('has back button navigating to /warehouse/grpo/material/history', () => {
    const content = readSource();
    expect(content).toContain("navigate('/warehouse/grpo/material/history')");
  });
});
