...
describe('useQCReportPrint hook', () => {
  const content = readSource('src/modules/warehouse/grpo/components/useQCReportPrint.tsx');
...
describe('QCReportButton', () => {
  const content = readSource('src/modules/warehouse/grpo/components/QCReportButton.tsx');
...
describe('GRPO inspection report print view (re-export)', () => {
  const content = readSource('src/modules/warehouse/grpo/components/QCInspectionReportPrint.tsx');
