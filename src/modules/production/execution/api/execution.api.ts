...
import type { AddBreakdownRequest, AnalyticsParams, ApproveClearanceRequest, BreakdownCategory, BulkChecklistRequest, ChecklistTemplate, CompleteRunRequest, CostAnalysisReport, CreateBreakdownCategoryRequest, CreateChecklistEntryRequest, CreateCompressedAirRequest, CreateElectricityRequest, CreateFinalQCRequest, CreateGasRequest, CreateInProcessQCRequest, CreateLabourRequest, CreateLineClearanceRequest, CreateLineRequest, CreateLineSkuConfigPayload, CreateMachineCostRequest, CreateMachineRequest, CreateManpowerRequest, CreateMaterialUsageRequest, CreateOverheadRequest, CreateRunRequest, CreateRuntimeRequest, CreateTemplateRequest, CreateWasteLogRequest, CreateWaterRequest, DowntimeAnalytics, DowntimeParetoReport, FinalQCCheck, InProcessQCCheck, LineClearance, LineClearanceDetail, LineSkuConfig, Machine, MachineBreakdown, MachineChecklistEntry, MachineRuntime, Manpower, MaterialUsage, MonthlySummaryReport, OEEAnalytics, OEETrendReport, PlanVsProductionReport, ProcurementVsPlannedReport, ProductionLine, ProductionRun, ProductionRunCost, ProductionRunDetail, ProductionSegment, ResolveBreakdownRequest, ResourceCompressedAir, ResourceConsumptionReport, ResourceElectricity, ResourceGas, ResourceLabour, ResourceMachineCost, ResourceOverhead, ResourceWater, SAPBOMResponse, SAPItem, SAPOrderDetail, SAPProductionOrder, StopProductionRequest, UpdateBreakdownRemarksRequest, UpdateLineClearanceRequest, UpdateLineSkuConfigPayload, UpdateRunRequest, UpdateSegmentRequest, WasteAnalytics, WasteApprovalRequest, WasteLog, WasteTrendReport, YieldReport } from '../types';
