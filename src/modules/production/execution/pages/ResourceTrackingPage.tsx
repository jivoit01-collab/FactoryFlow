      ...
      <Tabs defaultValue="labour" className="space-y-4">
        ...
        <TabsContent value="labour">
          <Card><CardContent className="p-4">
            ...
            <div className="overflow-x-auto"><table className="w-full text-sm min-w-[500px]">
              <thead><tr className="border-b bg-muted/50"><th scope="col" className="text-left p-2">Description</th><th scope="col" className="text-right p-2">Workers</th><th scope="col" className="text-right p-2">Hours</th><th scope="col" className="text-right p-2">Rate/hr</th><th scope="col" className="text-right p-2">Total</th><th scope="col" className="p-2" /></tr></thead>
        ...
        <TabsContent value="electricity">
          <Card><CardContent className="p-4">
            ...
            <div className="overflow-x-auto"><table className="w-full text-sm min-w-[500px]">
              <thead><tr className="border-b bg-muted/50"><th scope="col" className="text-left p-2">Description</th><th scope="col" className="text-right p-2">Units</th><th scope="col" className="text-right p-2">Rate</th><th scope="col" className="text-right p-2">Total</th><th scope="col" className="p-2" /></tr></thead>
        ...
        <TabsContent value="water">
          <Card><CardContent className="p-4">
            ...
            <div className="overflow-x-auto"><table className="w-full text-sm min-w-[500px]">
              <thead><tr className="border-b bg-muted/50"><th scope="col" className="text-left p-2">Description</th><th scope="col" className="text-right p-2">Volume</th><th scope="col" className="text-right p-2">Rate</th><th scope="col" className="text-right p-2">Total</th><th scope="col" className="p-2" /></tr></thead>
        ...
        <TabsContent value="gas">
          <Card><CardContent className="p-4">
            ...
            <div className="overflow-x-auto"><table className="w-full text-sm min-w-[500px]">
              <thead><tr className="border-b bg-muted/50"><th scope="col" className="text-left p-2">Description</th><th scope="col" className="text-right p-2">Qty</th><th scope="col" className="text-right p-2">Rate</th><th scope="col" className="text-right p-2">Total</th><th scope="col" className="p-2" /></tr></thead>
        ...
        <TabsContent value="machine">
          <Card><CardContent className="p-4">
            ...
            <div className="overflow-x-auto"><table className="w-full text-sm min-w-[500px]">
              <thead><tr className="border-b bg-muted/50"><th scope="col" className="text-left p-2">Machine</th><th scope="col" className="text-right p-2">Hours</th><th scope="col" className="text-right p-2">Rate/hr</th><th scope="col" className="text-right p-2">Total</th><th scope="col" className="p-2" /></tr></thead>
        ...
        <TabsContent value="overhead">
          <Card><CardContent className="p-4">
            ...
            <div className="overflow-x-auto"><table className="w-full text-sm min-w-[500px]">
              <thead><tr className="border-b bg-muted/50"><th scope="col" className="text-left p-2">Expense</th><th scope="col" className="text-right p-2">Amount</th><th scope="col" className="p-2" /></tr></thead>
