...
const COST_CATALOG: {
  ...
  },
  {
    ...
    label: 'Electricity — Fixed (per day)',
    defaultBasis: 'PER_DAY',
    hint: 'Fixed daily demand / sanctioned-load charge. Applied once per run.',
  },
  {
    category: 'LABOUR',
    label: 'Labour',
    defaultBasis: 'PER_PERSON_DAY',
    hint: 'Daily wage per worker. Cost = labour count × rate (never split into hours).',
  },
  {
    category: 'MANPOWER_SALARIED',
    label: 'Salary',
    defaultBasis: 'PER_DAY',
    hint: 'Daily salary — flat per day, or per head if set to Per Person per Day. Never split into hours.',
  },
  {
    category: 'LUBRICATION',
    label: 'Lubrication',
    defaultBasis: 'PER_DAY',
    hint: 'Lubricant cost. Flat per day, or per case.',
  },
  {
    category: 'LAB_CHEMICALS',
    label: 'Lab Chemicals',
    defaultBasis: 'PER_DAY',
    hint: 'QC lab chemical consumables. Flat per day, or per case.',
  },
  {
    category: 'BATCH_CODING',
    label: 'Batch Coding',
    defaultBasis: 'PER_DAY',
    hint: 'Batch coder ink/consumables. Flat per day, or per case.',
  },
  {
    category: 'MAINTENANCE',
    label: 'Maintenance',
    defaultBasis: 'PER_DAY',
    hint: 'Routine maintenance & spares. Flat per day, or per month.',
  },
  {
    category: 'WATER',
    label: 'Water',
    defaultBasis: 'PER_UNIT',
    hint: 'Water cost per case (or flat per day).',
  },
  {
    category: 'OVERHEAD',
    label: 'Overhead',
    defaultBasis: 'PER_DAY',
    hint: 'General plant overhead (rent / admin / ETP). Flat per day, or per month.',
  },
  {
