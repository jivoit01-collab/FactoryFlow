...
describe('Notification Service', () => {
  ...
  it('getNotifications passes params', async () => {
    ...
    expect(mockGet).toHaveBeenCalledWith('/notifications/', { params: { is_read: false, limit: 10 } })
  })
  ...
  it('markAsRead calls POST with notification_ids', async () => {
    ...
    expect(mockPost).toHaveBeenCalledWith('/notifications/mark-read/', { notification_ids: [1, 2, 3] })
