...
describe('Notification Types', () => {
  ...
  it('DeviceTokenResponse has all required fields', () => {
    const resp: DeviceTokenResponse = {
      id: 1, token: 'abc', platform: 'WEB', device_name: 'Chrome',
      is_active: true, created_at: '2024-01-01', last_used_at: '2024-01-02',
    }
  ...
  it('Notification has required fields', () => {
    const notif: Notification = {
      id: 1, type_code: 'QC_PENDING', title: 'Test', body: 'Body',
  ...
  it('NotificationDetail extends Notification with extra fields', () => {
    const detail: NotificationDetail = {
      id: 1, type_code: 'QC_PENDING', title: 'Test', body: 'Body',
      is_read: false, created_at: '2024-01-01',
      notification_type: { id: 1, code: 'QC_PENDING', name: 'QC Pending', description: 'Pending QC', is_active: true },
      data: { key: 'value' },
      status: 'SENT',
      read_at: null,
    }
  ...
  it('NotificationPreference has all fields', () => {
    const pref: NotificationPreference = {
      id: 1, code: 'QC_PENDING', name: 'QC', description: 'QC notifs', is_enabled: true,
    }
  ...
  it('NotificationPayload has title, body, and optional icon/data/tag', () => {
    const payload: NotificationPayload = {
      title: 'Alert', body: 'New item', icon: '/icon.png',
      data: { url: '/test' }, tag: 'tag1',
    }
