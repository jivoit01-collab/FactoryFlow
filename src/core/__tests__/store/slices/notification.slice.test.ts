...
describe('Notification Slice', () => {
  ...
  it('addNotification prepends to items and increments counts', () => {
    const notification = { id: 1, type_code: 'QC_PENDING', title: 'T', body: 'B', is_read: false, created_at: '2024-01-01' }
  ...
  it('clearNotifications empties items and resets counts', () => {
    const withItems = {
      ...initialState,
      notifications: { ...initialState.notifications, items: [{ id: 1 }] as any, unreadCount: 5, totalCount: 10 },
    }
  ...
  it('cleanupPushNotifications.fulfilled resets token and isInitialized', () => {
    const withToken = { ...initialState, fcm: { ...initialState.fcm, token: 'tok', isInitialized: true } }
