...
describe('API_ENDPOINTS.VEHICLE', () => {
  ...
  it('TRANSPORTER_BY_ID returns correct parameterized path', () => {
    expect(API_ENDPOINTS.VEHICLE.TRANSPORTER_BY_ID(5)).toBe(
      '/vehicle-management/transporters/5/'
    )
  })

  it('VEHICLE_BY_ID returns correct parameterized path', () => {
    expect(API_ENDPOINTS.VEHICLE.VEHICLE_BY_ID(10)).toBe(
      '/vehicle-management/vehicles/10/'
    )
  })
...
describe('API_ENDPOINTS.DRIVER', () => {
  ...
  it('DRIVER_BY_ID returns correct parameterized path', () => {
    expect(API_ENDPOINTS.DRIVER.DRIVER_BY_ID(7)).toBe(
      '/driver-management/drivers/7/'
    )
  })
})
...
describe('API_ENDPOINTS.SECURITY', () => {
  ...
  it('SUBMIT returns correct parameterized path', () => {
    expect(API_ENDPOINTS.SECURITY.SUBMIT(2)).toBe(
      '/security-checks/security/2/submit/'
    )
  })
})
...
describe('API_ENDPOINTS.PO', () => {
  ...
  it('OPEN_POS returns path with supplier code query param', () => {
    expect(API_ENDPOINTS.PO.OPEN_POS('SUP001')).toBe(
      '/po/open-pos/?supplier_code=SUP001'
    )
  })
})
